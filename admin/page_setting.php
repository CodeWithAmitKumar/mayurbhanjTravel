...
<head>
    <meta charset="utf-8">
    <title>Page Settings - Mayurbhanj Tourism Planner</title>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="page-header">
                ...
                <p>Select a settings category to configure</p>
            </div>

            <div class="settings-grid">
                <a href="header_settings.php" class="settings-card">
                    <div class="card-icon">
                ...
                <a href="footer_settings.php" class="settings-card">
                    <div class="card-icon">
                ...
                <a href="all_page_settings.php" class="settings-card">
                    <div class="card-icon">
                        <i class="fa fa-file"></i>
                    </div>
                    <div class="card-content">
                        <h3>All Page Settings</h3>
                ...
                <!-- <a href="home_settings.php" class="settings-card">
                    <div class="card-icon">
