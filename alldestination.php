...
<style>
    ...
    .destinations-hero::before {
        ...
        position: absolute;
        inset: 0;
        background: radial-gradient(circle at top right, rgba(255, 127, 80, 0.18), transparent 24%), radial-gradient(circle at bottom left, rgba(13, 110, 253, 0.14), transparent 28%);
        pointer-events: none;
    }
    ...
    /* Wrap the entire card in a block link */
    ...
    .destination-card-link:hover .destination-card-media img {
            ...
            <?php if (!empty($destinationRows)): ?>
                <div class="destinations-grid">
                    <?php foreach ($destinationRows as $destination): ?>
                        <a href="view_destination.php?id=<?php echo $destination['destination_id']; ?>" class="destination-card-link">
